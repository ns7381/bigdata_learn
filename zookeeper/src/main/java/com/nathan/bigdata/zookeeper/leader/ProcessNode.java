package com.nathan.bigdata.zookeeper.leader;

import com.nathan.bigdata.zookeeper.ZKManager;
import com.nathan.bigdata.zookeeper.ZKManagerImpl;
...
public class ProcessNode implements Runnable {
    ...
    private final ZKManager zooKeeperService;
    ...
    public ProcessNode(final int id, final String zkURL) throws IOException {
        this.id = id;
        zooKeeperService = new ZKManagerImpl(zkURL, new ProcessNodeWatcher());
    }
